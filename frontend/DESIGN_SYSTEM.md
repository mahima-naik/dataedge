...
#### 3. **demo.html** - Public Sandbox
**Navigation:**
- Overview
- Try Voice

**Sections:**
- Demo banner (informational)
- Platform features list (checkmarks)
- Demo roles showcase
- Recent activity sample
- Voice test setup form

#### 4. **factory.html** - Admin Control
**Navigation:**
- Overview
- Agent Registry
- Prompt Lab
...
### Before ❌
- 4 different product names (Procucev Pro, PitchX Demo, Revs Factory, Vernika Factory)
